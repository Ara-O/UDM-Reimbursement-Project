<template>
    ...
    <div>
        <h4 class="font-normal leading-7 w-auto max-w-[600px] text-sm text-gray-600">Proof of payments are necessary.
            These
        ...
        <h3 class="cursor-pointer text-sm underline font-normal" @click="openCameraPopup">Click here to take a picture
        </h3>
    </div>
