<template>
    ...
    <div class="max-h-96 h-auto overflow-auto">
        <skeleton height="5rem" borderRadius="6px" v-if="!foapa_numbers_has_loaded"></skeleton>
        <div v-else>
            <div v-for="foapa in foapa_data"
                ...
                <h4 class="my-0 text-nm font-medium text-ellipsis overflow-hidden max-w-56 whitespace-nowrap">
    ...
    <button
        class="bg-udmercy-blue cursor-pointer hover:bg-[#002060] transition-all duration-200 text-white w-full h-12 mt-3 text-nm rounded-full border"
