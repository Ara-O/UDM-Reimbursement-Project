<template>
  ...
  <main class="h-screen block xl:flex mt-40 xl:mt-0 items-center gap-20">
    ...
    <section class="w-auto">
      ...
      <finish :claim="currentReimbursement" v-if="selectedSection === 6" @on-claim-saved="onClaimSaved"></finish>
    </section>
    <confirmation-popup left-button-text="Discard Changes" right-button-text="Go back" v-if="show_confirm_dialog"
      ...
      <template #message>
        You are about to leave this page without saving this reimbursement claim. This will discard your changes. To go
        back, click 'Go back'. To discard your changes and leave the page, click 'Discard Changes'
      </template>
    </confirmation-popup>
  </main>
</template>
