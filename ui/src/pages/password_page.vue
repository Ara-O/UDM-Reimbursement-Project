 ...
 *
 * Checks if the new password matches the re-entered password. If not, sets
 * the feedback to "Passwords do not match, please try again".
 *
 * Checks if the new password matches the current password. If so, sets the
 * feedback to "New password can not match current password, please try again".
 *
 * If both checks pass, sends a POST request to the /api/changePassword endpoint
 * with the current password and new password. If successful, sets the feedback
 * to the response message. If the request fails, sets the feedback to the
 * error message.
 */
